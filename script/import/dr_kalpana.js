...
var treat02 = new  Dr_kalpana ('images/dr_kalpana/viltigo_treatment-in_luthra_hospital_bilapsur_dr_kalpana_luthra.jpg','Vitiligo Treatment','viltigo_treatment-in_luthra_hospital_bilapsur_dr_kalpana_luthra');
...
var treat04= new  Dr_kalpana('images/dr_kalpana/hair_redustion_treatment-in_luthra_hospital_bilapsur_dr_kalpana_luthra.jpg','Hair Reduction','hair_redustion_treatment-in_luthra_hospital_bilapsur_dr_kalpana_luthra');
...
document.querySelector('.dr_kalpana').innerHTML+=`
      <div class="container">
	       <div class="row">
		          <div class="col-md-12">
				       <img src="images/slider/hair_redution_in_luthra_hospital_bilaspur_nehru_nagar_by_dr_kalpana_luthra_cosmetologist.jpg" class="img-responsive">
					    <br></br> <br></br>
						<h1>O.P.D. Time :</h1>
						<table class="table">
							<tbody>
